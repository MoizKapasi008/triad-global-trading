...
//     categoryId: "spices",
//     description:
//       "Turn up the heat and ignite your taste budswith the fiery kick of chilli !",
...
//           "Uses: Culinary purposes, spice blends, oleoresin extraction, and food coloring.",
//         ],
//       },
//       {
...
//         items: [
//           "20 FT Container: 7–8 Metric Tons (MT)",
//           "40 FT Container: 14–15 Metric Tons (MT)",
//         ],
//       },
//       {
//         title: "Key Features",
...
//     ],
//     chemicalSpecs: [
//       { parameter: "Capsaicin Content", value: "0.2% to 0.5%" },
//       {
...
//       Admixture: "< 1%",
//       Origin: "India",
//       Packaging: "25kg PP | 5kg x 4 cartons | Custom",
//     },
//     badges: ["FSSAI", "HACCP", "GMP"],
//   },
//   {
//     id: "turmeric-powder",
...
//         title: "Product Information",
//         items: [
//           "Whole dried cumin seeds with earthy, warm flavor",
//           "Popular in Indian, Middle Eastern, and Latin cuisines",
//           "Uses: Curries, spice blends, pickles, bakery, and beverages",
//         ],
//       },
//       {
//         title: "Packing and Shipping Details",
//         items: [
//           "Jute/PP Bags with liner: 25kg / 50kg",
//           "Custom small retail packs available",
//         ],
//       },
//       {
//         title: "Container Load",
...
//         title: "Key Features",
//         items: [
//           "Uniformly sized, machine-cleaned seeds",
//           "Strong aroma and flavor retention",
//           "Free from stones, dust, and adulteration",
//         ],
//       },
//     ],
//     physicalSpecs: [
//       { parameter: "Color", value: "Brownish-yellow" },
//       { parameter: "Length", value: "3–6 mm" },
//       { parameter: "Moisture Content", value: "8–10% max" },
//       { parameter: "Foreign Matter", value: "< 1%" },
//     ],
//     chemicalSpecs: [
//       { parameter: "Volatile Oil", value: "1.5–4%" },
//       { parameter: "Total Ash", value: "< 9.5%" },
//       { parameter: "Acid Insoluble Ash", value: "< 1.5%" },
//       { parameter: "Salmonella", value: "Absent in 25g" },
//     ],
//     originMapSrc: "/images/product-origin.jpg",
//     specs: {
//       "HS Code": "090931",
...
//       Admixture: "< 1%",
//       Origin: "India",
//       Packaging: "25kg / 50kg bags | Custom",
//     },
//     badges: ["FSSAI", "HACCP", "Kosher"],
//   },
// ];
  ...
  // -------------------- HERBS & LEAVES --------------------
{
  ...
  originMapSrc: "/images/product-origin.jpg",
  specs: { "HS Code": "070999", Origin: "India", Packaging: "Cartons | Custom" },
  badges: ["FSSAI", "HACCP"],
},

{
  ...
  originMapSrc: "/images/product-origin.jpg",
  specs: { "HS Code": "091099", Origin: "India", Packaging: "Cartons | Pouches | Custom" },
  badges: ["FSSAI", "HACCP"],
},

{
  ...
  title: "Curry Leaves",
  categoryId: "herbs-leaves",
  description: "Essential herb in South Indian cooking, aromatic and flavorful.",
  ...
  chemicalSpecs: [
    { parameter: "Alkaloids", value: "Carbazole alkaloids (antioxidant properties)" },
  ...
  // -------------------- SEEDS --------------------
{
  ...
  originMapSrc: "/images/product-origin.jpg",
  specs: { "HS Code": "090931", Origin: "India", Packaging: "25kg PP | Retail pouches | Custom" },
  badges: ["FSSAI", "Kosher"],
},

{
  ...
  title: "Sesame Seeds",
  categoryId: "seeds",
  description: "Nutty-flavored seeds used in bakery, oil extraction, and snacks.",
  ...
  originMapSrc: "/images/product-origin.jpg",
  specs: { "HS Code": "120740", Origin: "India", Packaging: "25kg PP | Retail packs | Custom" },
  badges: ["FSSAI", "HACCP"],
},

{
  ...
  originMapSrc: "/images/product-origin.jpg",
  specs: { "HS Code": "120400", Origin: "India", Packaging: "25kg PP | Retail packs | Custom" },
  ...
  // -------------------- DRIED FRUITS & NUTS --------------------
{
  ...
  originMapSrc: "/images/product-origin.jpg",
  specs: { "HS Code": "080212", Origin: "USA/India", Packaging: "25kg PP | Retail packs | Custom" },
  badges: ["FSSAI"],
},
{
  id: "cashews",
  ...
  originMapSrc: "/images/product-origin.jpg",
  specs: { "HS Code": "080131", Origin: "India", Packaging: "25kg PP | Retail packs | Custom" },
  badges: ["FSSAI"],
},
{
  id: "raisins",
  ...
  originMapSrc: "/images/product-origin.jpg",
  specs: { "HS Code": "080620", Origin: "India", Packaging: "25kg PP | Retail packs | Custom" },
  badges: ["FSSAI"],
},
...
// -------------------- DEHYDRATED PRODUCTS --------------------
{
  ...
  originMapSrc: "/images/product-origin.jpg",
  specs: { "HS Code": "071220", Origin: "India", Packaging: "25kg PP | Retail packs | Custom" },
  badges: ["FSSAI"],
},
{
  ...
  originMapSrc: "/images/product-origin.jpg",
  specs: { "HS Code": "071290", Origin: "India", Packaging: "25kg PP | Retail packs | Custom" },
  badges: ["FSSAI"],
},
{
...
// -------------------- COCONUT PRODUCTS --------------------
{
  ...
  originMapSrc: "/images/product-origin.jpg",
  specs: { "HS Code": "080112", Origin: "India", Packaging: "25kg PP | Retail packs | Custom" },
  badges: ["FSSAI"],
},
{
  id: "coconut-oil",
  title: "Coconut Oil",
  categoryId: "coconut-products",
  description: "Cold-pressed and refined coconut oil for cooking and cosmetics.",
  ...
  originMapSrc: "/images/product-origin.jpg",
  specs: { "HS Code": "151319", Origin: "India", Packaging: "1L/5L/20L | Custom" },
  badges: ["FSSAI"],
},
{
  ...
  originMapSrc: "/images/product-origin.jpg",
  specs: { "HS Code": "210690", Origin: "India", Packaging: "25kg PP | Retail packs | Custom" },
  badges: ["FSSAI"],
},
...
// -------------------- COFFEE --------------------
{
  ...
  originMapSrc: "/images/product-origin.jpg",
  specs: { "HS Code": "090111", Origin: "India", Packaging: "5kg/10kg/60kg | Custom" },
  badges: ["FSSAI"],
},
{
  id: "robusta-coffee",
  ...
  categoryId: "coffee",
  description: "Strong flavor, high caffeine content, used in blends and espresso.",
  ...
  originMapSrc: "/images/product-origin.jpg",
  specs: { "HS Code": "090112", Origin: "India", Packaging: "5kg/10kg/60kg | Custom" },
  badges: ["FSSAI"],
},
{
  id: "ground-coffee",
  ...
  originMapSrc: "/images/product-origin.jpg",
  specs: { "HS Code": "090121", Origin: "India", Packaging: "1kg/5kg/10kg | Custom" },
  badges: ["FSSAI"],
},
