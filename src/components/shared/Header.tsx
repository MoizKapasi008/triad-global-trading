...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 w-full bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      {/* Top Info Bar */}
      <div className="hidden md:grid w-full bg-secondary text-white px-5 py-1 h-10 grid-cols-3 items-center text-xs font-bold">
      ...
      <div className="w-full bg-primary">
        <div className="flex items-center justify-between px-5 py-4 md:py-4 md:px-5">
          {/* Mobile Menu Button */}
          ...
          <div className="flex justify-center items-center flex-shrink-0">
            <Link href="/">
              <div className="relative w-32 h-12 md:w-48 md:h-14">
                <Image
          ...
          <div className="hidden md:flex justify-end items-center space-x-4">
            <RightNavigationMenu />
            <Button className=" 
   bg-primary border-1 border-white 
    ...
    hover:text-primary ">
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden fixed top-full left-0 w-full bg-primary/80 backdrop-blur-md  px-5 py-4 z-50 max-h-[80vh] overflow-y-auto">
            <ul className="flex flex-col space-y-2 text-primary-foreground text-sm font-semibold">
              {/* Products Dropdown */}
              <li>
                <button
                  onClick={() =>
